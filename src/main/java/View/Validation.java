...
public static Date checkInputDob() {
    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");

    while (true) {
        String dobString = checkInputString();
        try {
            ...
            cal.setTime(dob);
            cal.getTime(); // This will throw an exception for an invalid date
            return dob; // Return the valid date
        } catch (ParseException e) {
            System.err.println("Invalid date format. Please use yyyy-MM-dd.");
            System.out.print("Enter date of birth again: ");
        }
    }
}
